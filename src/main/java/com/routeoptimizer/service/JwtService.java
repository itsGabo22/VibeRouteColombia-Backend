 ...
 * Provee métodos para generar, validar y extraer información de tokens.
 * The secret key is injected from an environment variable (JWT_SECRET) to
 * avoid hardcoding sensitive values in source code.
 */
@Service
public class JwtService {

  // Injected from environment variable JWT_SECRET — never hardcode secrets in
  // source code
  @Value("${jwt.secret}")
